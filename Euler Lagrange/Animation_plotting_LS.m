...
figure(1);
set(figure(1),'Position',[200,100,1200,500]);
p = plot3(1,1,0,'o');
norm_plot1 = zeros(length(res.x1.data),1);
xs=[];ys=[];zs=[];
view(20, -10)

for i = 1:20:length(res.x1.data)
    ...
    norm_plot1(i) = norm([res.joint1.data(1,1,i) res.joint1.data(2,1,i) res.joint1.data(3,1,i)]);

    bar_17_1 = line([res.x1.data(i,1) res.joint1.data(1,1,i)],[res.x1.data(i,2) res.joint1.data(2,1,i)],[res.x1.data(i,3) res.joint1.data(3,1,i)],'linestyle','-','color','b','LineWidth',3);
    bar_17_2 = line([res.x7.data(i,1) res.joint1.data(1,1,i)],[res.x7.data(i,2) res.joint1.data(2,1,i)],[res.x7.data(i,3) res.joint1.data(3,1,i)],'linestyle','-','color','b','LineWidth',3);
    bar_28_1 = line([res.x2.data(i,1) res.joint2.data(1,1,i)],[res.x2.data(i,2) res.joint2.data(2,1,i)],[res.x2.data(i,3) res.joint2.data(3,1,i)],'linestyle','-','color','r','LineWidth',3);
    bar_28_2 = line([res.x8.data(i,1) res.joint2.data(1,1,i)],[res.x8.data(i,2) res.joint2.data(2,1,i)],[res.x8.data(i,3) res.joint2.data(3,1,i)],'linestyle','-','color','r','LineWidth',3);
    bar_39_1 = line([res.x3.data(i,1) res.joint3.data(1,1,i)],[res.x3.data(i,2) res.joint3.data(2,1,i)],[res.x3.data(i,3) res.joint3.data(3,1,i)],'linestyle','-','color','r','LineWidth',3);
    bar_39_2 = line([res.joint3.data(1,1,i) res.x9.data(i,1)],[res.joint3.data(2,1,i) res.x9.data(i,2)],[res.joint3.data(3,1,i) res.x9.data(i,3)],'linestyle','-','color','r','LineWidth',3);
    bar_410_1 = line([res.x4.data(i,1) res.joint4.data(1,1,i)],[res.x4.data(i,2) res.joint4.data(2,1,i)],[res.x4.data(i,3) res.joint4.data(3,1,i)],'linestyle','-','color','r','LineWidth',3);
    bar_410_2 = line([res.joint4.data(1,1,i) res.x10.data(i,1)],[res.joint4.data(2,1,i) res.x10.data(i,2)],[res.joint4.data(3,1,i) res.x10.data(i,3)],'linestyle','-','color','r','LineWidth',3);
    bar_511_1 = line([res.x5.data(i,1) res.joint5.data(1,1,i)],[res.x5.data(i,2) res.joint5.data(2,1,i)],[res.x5.data(i,3) res.joint5.data(3,1,i)],'linestyle','-','color','r','LineWidth',3);
    bar_511_2 = line([res.joint5.data(1,1,i) res.x11.data(i,1)],[res.joint5.data(2,1,i) res.x11.data(i,2)],[res.joint5.data(3,1,i) res.x11.data(i,3)],'linestyle','-','color','r','LineWidth',3);
    bar_612_1 = line([res.x6.data(i,1) res.joint6.data(1,1,i)],[res.x6.data(i,2) res.joint6.data(2,1,i)],[res.x6.data(i,3) res.joint6.data(3,1,i)],'linestyle','-','color','b','LineWidth',3);
    bar_612_2 = line([res.joint6.data(1,1,i) res.x12.data(i,1)],[res.joint6.data(2,1,i) res.x12.data(i,2)],[res.joint6.data(3,1,i) res.x12.data(i,3)],'linestyle','-','color','b','LineWidth',3);
